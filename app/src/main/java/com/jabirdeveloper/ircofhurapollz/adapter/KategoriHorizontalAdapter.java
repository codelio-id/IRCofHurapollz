...
public class KategoriHorizontalAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private Context context;
    private List<WpPostModel> items;

    public KategoriHorizontalAdapter(Context context, List<WpPostModel> items) {
