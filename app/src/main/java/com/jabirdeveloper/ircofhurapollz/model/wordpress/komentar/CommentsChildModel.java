...
public class CommentsChildModel {
    ...
    public CommentsChildModel() {
    }

    public CommentsChildModel(int id, int post, int parent, int author, String authorName, String date, String dateGmt, Rendered content, String link, AuthorAvatar authorAvatar, List<CommentsChildModel> childList) {
        this.id = id;
        this.post = post;
        this.parent = parent;
        this.author = author;
